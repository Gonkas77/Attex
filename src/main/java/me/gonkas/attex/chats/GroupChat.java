...
public class GroupChat {
    ...
    public ArrayList<String> getPlayerNames() {
        ...
        for (Player player : this.getPlayers()) {names.add(player.getName());}
        return names;
    }
    ...
    public void promotionAnnouncement(Player player) {
        for (Player p : this.players) {this.info("Player §b" + player.getName() + "§f has become the owner of this group chat!");}
    }
